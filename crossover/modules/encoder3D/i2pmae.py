# From: https://github.com/ZiyuGuo99/Point-Bind_Point-LLM/blob/main/models/i2p_mae/I2P_MAE.py
import torch
...
from .modules import *
from modules.build import ENCODER3D_REGISTRY
...
@ENCODER3D_REGISTRY.register()
class I2PMAE(nn.Module):
    def __init__(self):
        super().__init__()
        # tokenizers
